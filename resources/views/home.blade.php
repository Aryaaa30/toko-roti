...
<section class="hero-section" style="
    background-image: url('https://scontent.fcgk30-1.fna.fbcdn.net/v/t39.30808-6/490092247_9768915553160390_4770096036672565560_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=86c6b0&_nc_ohc=88mDjCux2xMQ7kNvwGEvGpE&_nc_oc=AdmDu7RXo0TaHWXqScxFcPLvP0YcyREiRhK2pt6knbkqhABXMpxrJTJJExQhn8Z_ns8&_nc_zt=23&_nc_ht=scontent.fcgk30-1.fna&_nc_gid=dT9lzadIVKH176vHg6hRfA&oh=00_AfPlKQa8MPuNVC1PAR5LaYpLS8LHk_g6ZBbZmgWfU8LRAg&oe=6854251E');
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; color: rgb(254, 198, 228); font-weight: 600;">
                            <div style="display: flex; align-items: center;">
                                ...
                                <span style="color: rgb(245, 245, 245);">
                                    {{ $menu->reviews->count() > 0 ? round($menu->reviews->avg('rating'), 1) : '0.0' }}
                                </span>
                            </div>
