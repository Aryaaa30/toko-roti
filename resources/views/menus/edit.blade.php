    ...
    <div class="form-section">
        ...
        <form action="{{ route('menus.update', $menu->id) }}" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-4">
                ...
                @if ($menu->image)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $menu->image) }}" alt="{{ $menu->name }}" width="150" style="border-radius: 8px;">
                    </div>
                @endif
                <input type="file" name="image" id="image" class="form-control" accept="image/*">
                <small class="form-text text-muted">Upload gambar baru jika ingin mengganti gambar lama. Maks 2MB.</small>
            </div>
